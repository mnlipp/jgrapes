...
public class HttpFreemarker extends AbstractProject
    ...
    public static class HttpFreemarkerTest extends AbstractProject
            implements JavaProject, MergedTestProject {

        public HttpFreemarkerTest() {
            super(parent(HttpFreemarker.class));

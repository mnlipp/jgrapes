 ...
 * backed by a YAML file. The YAML object described by this file 
 ...
 * on its channel and updates the YAML file (may be suppressed).
 */
...
public class YamlConfigurationStore extends NightConfigStore {
     ...
     * @param file the file used to store the YAML

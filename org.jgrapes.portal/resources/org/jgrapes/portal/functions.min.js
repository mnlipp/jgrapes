...
else{var a=null,d=this;this._ws.onopen=function(){d._ws.send(JSON.stringify({jsonrpc:"2.0",method:"connect",params:[d._portalSessionId]}));d._drainSendQueue();setInterval(function(){a=d.send({jsonrpc:"2.0",method:"keepAlive",params:[]})},JGPortal.portalSessionRefreshInterval)};this._ws.onclose=function(e){clearInterval(a);d._initiateReconnect()};this._ws.onerror=function(a){d._initiateReconnect()};this._ws.onmessage=function(a){a=JSON.parse(a.data);d._recvQueue.push(a);1===d._recvQueue.length&&d._handleMessages()}}};
